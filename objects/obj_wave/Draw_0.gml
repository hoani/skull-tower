...
draw_sprite_ext(wave, 1, x, y, image_xscale, image_yscale, image_angle, C_PINK, 1.0);
...
draw_sprite_ext(wave, 0, x, y, image_xscale, image_yscale, image_angle, C_PINK, 1.0);
