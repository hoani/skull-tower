...
function gluttony_controller_update(_state) {
    var _boss_index = BI_GLUTTONY;
    var _obj_intro = obj_gluttony_intro;
    var _obj_boss = obj_gluttony;
    var _music = MUSIC_GLUTTONY;
